"""生成 A092 Claude Code 确认性实验 v3 的组件冻结记录。"""
...
OUTPUT = ROOT / "protocols" / "a092_v3" / "protocol_freeze.json"
COMPONENTS = (
    "protocols/a092_v3/a092_confirmatory_v3.json",
    "schemas/a092_confirmatory_v3.schema.json",
